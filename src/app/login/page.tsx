...
export default function LoginPage() {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        if (email === "therightfollowers@gmail.com" && password === "Kla!Hoxhaj2") {
            ...
            <div className="flex-1 flex flex-col items-center justify-center py-20 px-4">
                <div className={`w-full max-w-md ${shake ? "animate-shake" : ""}`}>
                    ...
                    <div className="text-center mb-8">
                        <span className="block text-3xl text-orange font-handwriting mb-2 rotate-[-2deg]" style={{ fontFamily: 'var(--font-caveat)' }}>
                            {t("login.welcome")}
                        </span>
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit} noValidate>
                        ...
                        <div className="text-right">
                            <a href="#" className="text-xs text-muted hover:text-orange transition-colors">
                                {t("login.forgot")}
                            </a>
                        </div>
                        ...
                        <button
                            type="submit"
                            className="w-full py-4 rounded-xl bg-gradient-to-r from-[#FBC144] to-[#F28E46] text-white font-bold text-base shadow-lg shadow-orange/20 hover:shadow-xl hover:scale-[1.02] transition-all"
                        >
                            {t("login.submit")}
                        </button>
                    </form>
                    ...
                    <div className="mt-8 text-center text-sm">
                        ...
                        <Link href="/register" className="text-orange font-bold hover:underline decoration-2 underline-offset-4">
                            {t("login.register")}
                        </Link>
                    </div>
